...
public class RPmmlHandler extends BasePmmlHandler {
    ...
    private Class<? extends Converter<? extends RExp>> converterForType(RConverterType converterType) {
        switch (converterType) {
            case ADA:
                return AdaConverter.class;
            case ADABAG:
                return AdaBagConverter.class;
            case BAGGING:
                return BaggingConverter.class;
            case BINARYTREE:
                return BinaryTreeConverter.class;
            case BOOSTING:
                return BoostingConverter.class;
            case CARET:
                return CaretEnsembleConverter.class;
            case CROSSVALGLMNET:
                return CrossValGLMNetConverter.class;
            case EARTH:
                return EarthConverter.class;
            case ELMNN:
                return ElmNNConverter.class;
            case GBM:
                return GBMConverter.class;
            case GLM:
                return GLMConverter.class;
            case GLMNET:
                return GLMNetConverter.class;
            case IFOREST:
                return IForestConverter.class;
            case KMEANS:
                return KMeansConverter.class;
            case LM:
                return LMConverter.class;
            case LRM:
                return LRMConverter.class;
            case MVR:
                return MVRConverter.class;
            case MULTINOM:
                return MultinomConverter.class;
            case NN:
                return NNConverter.class;
            case NNet:
                return NNetConverter.class;
            case NAIVEBAYES:
                return NaiveBayesConverter.class;
            case OLS:
                return OLSConverter.class;
            case PARTY:
                return PartyConverter.class;
            case RANDOMFOREST:
                return RandomForestConverter.class;
            case SVM:
                return SVMConverter.class;
            case XGBOOST:
                return XGBoostConverter.class;
            default:
                throw new IllegalArgumentException("Illegal converter type");
