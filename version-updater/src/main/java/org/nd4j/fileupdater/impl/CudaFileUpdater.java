...
public class CudaFileUpdater implements FileUpdater {
    ...
    public Map<String,String> patterns() {
        ...
        ret.put( "\\<javacpp\\.presets\\.cuda\\.version\\>[0-9\\.\\$\\{\\}a-zA-Z]*<\\/javacpp\\.presets\\.cuda\\.version\\>",String.format("<javacpp.presets.cuda.version>%s</javacpp.presets.cuda.version>",javacppVersion));
        return ret;
    }
}
