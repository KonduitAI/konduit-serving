...
@NotThreadSafe
public class KerasPythonJsonNumpyFormatTest extends BaseMultiNumpyVerticalTest {
    ...
    public void testInferenceClassificationResult(TestContext context) throws Exception {
        ...
        INDArray outputArray = Nd4j.createNpyFromByteArray(output.getBody().asByteArray());
        INDArray expectedArr = (INDArray) ExpectedAssertUtil.probabilitiesToJsonArray("src/test/resources/Json/keras/KerasJsonNumpyTest.json");
        assertEquals(expectedArr, outputArray);
    }
}
