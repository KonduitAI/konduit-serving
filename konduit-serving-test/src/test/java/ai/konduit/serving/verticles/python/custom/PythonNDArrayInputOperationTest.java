...
@NotThreadSafe
public class PythonNDArrayInputOperationTest extends BaseMultiNumpyVerticalTest {
    ...
    public void testInferenceResult(TestContext context) throws Exception {
        ...
        INDArray inputArray = Nd4j.create(new double[]{1,2,3} , new int[]{3});
        jsonObject.put("inputVar", new JsonArray(inputArray.toString()));
        ...
        INDArray expected = Nd4j.create(new double[]{1,2,3,4,5,6} , new int[]{2,3});
