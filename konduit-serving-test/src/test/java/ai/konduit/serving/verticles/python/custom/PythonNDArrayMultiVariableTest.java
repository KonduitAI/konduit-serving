...
@NotThreadSafe
public class PythonNDArrayMultiVariableTest extends BaseMultiNumpyVerticalTest {
    ...
    public JsonObject getConfigObject() throws Exception {
        ...
        String pythonCodePath = new ClassPathResource("scripts/custom/add_array_test.py").getFile().getAbsolutePath();
    ...
    public void testInferenceResult(TestContext context) throws Exception {
        ...
        jsonObject.put("array1", new JsonArray(inputArray.toString()));
        System.out.println(inputArray);
        jsonObject.put("array2", new JsonArray(inputArray.toString()));
        ...
        INDArray expected = inputArray.add(inputArray);
