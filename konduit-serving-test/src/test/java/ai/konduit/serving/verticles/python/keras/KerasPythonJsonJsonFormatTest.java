...
public class KerasPythonJsonJsonFormatTest extends BaseMultiNumpyVerticalTest {
    ...
    public void testInferenceResult(TestContext context) throws Exception {
        ...
        INDArray expectedArr = ExpectedAssertUtil.fileAndKeyToNDArrayOutput("src/test/resources/Json/keras/KerasJsonTest.json", "raw");
    ...
    public void testInferenceClassificationResult(TestContext context) throws Exception {
        ...
        JsonArray expArr = ExpectedAssertUtil.probabilitiesToJsonArray("src/test/resources/Json/keras/KerasJsonTest.json");
