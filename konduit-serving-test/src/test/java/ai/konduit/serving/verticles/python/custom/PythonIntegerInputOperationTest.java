...
@NotThreadSafe
public class PythonIntegerInputOperationTest extends BaseMultiNumpyVerticalTest {
    ...
    public JsonObject getConfigObject() throws Exception {
        ...
        PythonConfig pythonConfig = PythonConfig.builder()
                ...
                .pythonInput("inputVar", PythonType.TypeName.INT.name())
                .pythonOutput("output", PythonType.TypeName.INT.name())
                .build();
    ...
    public void testInferenceResult(TestContext context) throws Exception {
        ...
        assertEquals(100, result.getInteger("output"), 1e-1);
