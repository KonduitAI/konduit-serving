...
@NotThreadSafe
public class PytorchPythonNumpyNd4jFormatTest_v1 extends BaseMultiNumpyVerticalTest {
    ...
    public void testInferenceResult(TestContext context) throws Exception {
        ...
        INDArray expectedArr = ExpectedAssertUtil.NdArrayAssert("src/test/resources/Json/pytorch/PytorchNumpyTest.json", "raw_v1");
