...
//        return new JsonObject();
	...
	byte[] npyContents = Nd4j.toNpyByteArray(contents);
        ...
        //FileUtils.writeByteArrayToFile(inputFile, Arrays.asList(npyContents));

	//TODO: optimize; don't create new byte array, don't write to file
	//Buffer inputBuffer = convertBatchOutput(contents, Output.DataFormat.NUMPY);
