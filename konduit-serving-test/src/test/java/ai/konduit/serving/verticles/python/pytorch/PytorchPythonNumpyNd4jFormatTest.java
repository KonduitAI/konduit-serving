...
@NotThreadSafe
public class PytorchPythonNumpyNd4jFormatTest extends BaseMultiNumpyVerticalTest {
    ...
    public void testInferenceResult(TestContext context) throws Exception {
        ...
        INDArray expectedArr = ExpectedAssertTest.NdArrayAssert("src/test/resources/Json/pytorch/PytorchNumpyTest.json", "raw");
  ...
  //  @Test
    public void testInferenceClassificationResult(TestContext context) throws Exception {
        ...
        System.out.println(BinarySerde.readFromDisk(outputImagePath));
        INDArray outputArray = BinarySerde.readFromDisk(outputImagePath);
        INDArray expectedArr = ExpectedAssertTest.NdArrayAssert("src/test/resources/Json/pytorch/PytorchNumpyTest.json", "classification");
        assertEquals(expectedArr.getInt(0), outputArray.getInt(0));
        assertEquals(expectedArr, outputArray);
    }
