...
@NotThreadSafe
public class PythonSTRInputOperationTest extends BaseMultiNumpyVerticalTest {
    ...
    public void testInferenceResult(TestContext context) throws Exception {
        ...
        String strTest = "Test for data type";
        String exp = "Test for data type String";
        ...
        assertEquals(exp, jsonObject1.getString("output"));
