...
public class FakerIntDataGenerator extends BaseFakerDataGenerator<Integer> {
    public FakerIntDataGenerator(Faker faker) {
        super(faker);
    }

    public FakerIntDataGenerator(long seed) {
        super(seed);
    }

    public FakerIntDataGenerator() {
    }
