...
class PipelineStep(object):
    ...
    def as_dict(self):
        ...
        if self.__runner is not None:
            d['runner']  =  self.__runner.as_dict() if hasattr(self.__runner, 'as_dict') else self.__runner
        return d
...
class ImageLoadingStep(PipelineStep):
    ...
    def as_dict(self):
        ...
        if self.__update_ordering_before_transform is not None:
            d['updateOrderingBeforeTransform']  =  self.__update_ordering_before_transform.as_dict() if hasattr(self.__update_ordering_before_transform, 'as_dict') else self.__update_ordering_before_transform
...
class InferenceConfiguration(object):
    ...
    def as_dict(self):
        ...
        if self.__mem_map_config is not None:
            d['memMapConfig']  =  self.__mem_map_config.as_dict() if hasattr(self.__mem_map_config, 'as_dict') else self.__mem_map_config
        return d
