 ...
 ******************************************************************************/
package ai.konduit.serving.models.tensorflow.serde;
...
public class TFJsonSubTypesMapping implements JsonSubTypesMapping {
    ...
    public List<JsonSubType> getSubTypesMapping() {
        ...
        l.add(new JsonSubType("TENSORFLOW", TensorFlowPipelineStep.class, PipelineStep.class));
        l.add(new JsonSubType("TENSORFLOW_CONFIG", TensorFlowConfiguration.class, Configuration.class));
