...
public class SameDiffTrainerPipelineStepRunnerFactory implements PipelineStepRunnerFactory {


    @Override
    public boolean canRun(PipelineStep pipelineStep) {
        return pipelineStep instanceof SameDiffTrainerStep;
    }
    ...
    public PipelineStepRunner create(PipelineStep pipelineStep) {
        ...
        SameDiffTrainerStep ps = (SameDiffTrainerStep)pipelineStep;
        return new SameDiffTrainerRunner(ps);
    }
}
