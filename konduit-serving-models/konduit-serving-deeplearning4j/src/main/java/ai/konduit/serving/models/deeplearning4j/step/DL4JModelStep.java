...
public class DL4JModelStep implements PipelineStep {
    ...
    public DL4JModelStep(@JsonProperty("modelUri") String modelUri, @JsonProperty("inputNames") List<String> inputNames,
