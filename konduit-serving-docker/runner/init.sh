...
if [[ -f "${KONDUIT_PRE_SETUP_FILE}" ]]
then
  echo "Executing pre setup script from ${KONDUIT_PRE_SETUP_FILE}"

  bash "${KONDUIT_PRE_SETUP_FILE}"
fi
...
if [[ -f "${KONDUIT_POST_SETUP_FILE}" ]]
then
  echo "Executing post setup script from ${KONDUIT_POST_SETUP_FILE}"

  bash "${KONDUIT_POST_SETUP_FILE}"
fi
