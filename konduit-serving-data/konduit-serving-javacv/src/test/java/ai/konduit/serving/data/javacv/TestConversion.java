...
package ai.konduit.serving.data.javacv;
...
public class TestConversion {
    ...
    public void testConversion(){
        ...
        Image iMat = Image.create(mat);
        Image iFrame = Image.create(frame);
        Image iCVMat = Image.create(opencvMat);
