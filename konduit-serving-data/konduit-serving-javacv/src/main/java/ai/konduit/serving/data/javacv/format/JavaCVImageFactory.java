...
import ai.konduit.serving.data.javacv.data.FrameImage;
import ai.konduit.serving.data.javacv.data.OpenCVMatImage;
import ai.konduit.serving.data.javacv.data.MatImage;
