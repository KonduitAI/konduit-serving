...
public class DrawFixedGridStep implements PipelineStep {
    ...
    @Schema(description = "Color of the border. " + ColorConstants.COLOR_DESCRIPTION)
    private String borderColor;

    @Schema(description = "Color of the grid. If not set, the border color will be used. " + ColorConstants.COLOR_DESCRIPTION)
