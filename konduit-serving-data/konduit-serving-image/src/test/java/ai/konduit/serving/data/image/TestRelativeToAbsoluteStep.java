...
public class TestRelativeToAbsoluteStep {
    ...
    public void testRelativeToAbsolute(){
        ...
        d.put("box", BoundingBox.create(0.5, 0.6, 0.2, 0.3));
        d.putListBoundingBox("boxList", Arrays.asList(BoundingBox.create(0.5, 0.6, 0.2, 0.3)));
        ...
        BoundingBox bb = BoundingBox.create(0.4*300, 0.3*200, 0.2*200, 0.3*300);
        ...
        assertEquals(Collections.singletonList(bb), out.getListBoundingBox("ptBox"));
