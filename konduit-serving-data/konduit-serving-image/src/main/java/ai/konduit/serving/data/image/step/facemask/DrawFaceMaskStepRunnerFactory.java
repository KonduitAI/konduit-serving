...
public class DrawFaceMaskStepRunnerFactory implements PipelineStepRunnerFactory {
    @Override
    public boolean canRun(PipelineStep pipelineStep) {
        return pipelineStep instanceof DrawFaceMaskStep;
    }
    ...
    public PipelineStepRunner create(PipelineStep pipelineStep) {
        ...
        return new DrawFaceMaskStepRunner((DrawFaceMaskStep) pipelineStep);
    }
}
