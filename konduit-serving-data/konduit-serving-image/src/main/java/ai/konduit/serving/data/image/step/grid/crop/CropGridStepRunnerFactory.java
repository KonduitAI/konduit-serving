...
public class CropGridStepRunnerFactory implements PipelineStepRunnerFactory {
    @Override
    public boolean canRun(PipelineStep pipelineStep) {
        return pipelineStep instanceof CropGridStep || pipelineStep instanceof CropFixedGridStep;
    }
