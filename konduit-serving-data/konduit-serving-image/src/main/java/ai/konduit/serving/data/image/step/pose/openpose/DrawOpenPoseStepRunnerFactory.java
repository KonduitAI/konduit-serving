...
public class DrawOpenPoseStepRunnerFactory implements PipelineStepRunnerFactory {
    @Override
    public boolean canRun(PipelineStep pipelineStep) {
        return pipelineStep instanceof DrawOpenPoseStep;
    }
    ...
    public PipelineStepRunner create(PipelineStep pipelineStep) {
        ...
        return new DrawOpenPoseStepRunner((DrawOpenPoseStep) pipelineStep);
    }
}
