...
@Schema(description = "An enum that represents the type (and order) of the channels for an image after it has " +
        "been converted to an NDArray. RGB -> 3 channels, ordered according to: red, green, blue - most common for " +
        "TensorFlow, Keras, and some other libraries, BGR -> 3 channels, ordered according to: blue, green, red - " +
        "the default for OpenCV, JavaCV, DL4J, RGBA -> 4 channels, ordered according to: red, green, blue, alpha, " +
