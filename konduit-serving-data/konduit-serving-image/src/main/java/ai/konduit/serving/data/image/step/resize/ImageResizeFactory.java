...
public class ImageResizeFactory implements PipelineStepRunnerFactory {
    @Override
    public boolean canRun(PipelineStep pipelineStep) {
        return pipelineStep instanceof ImageResizeStep;
    }
    ...
    public PipelineStepRunner create(PipelineStep pipelineStep) {
        ...
        return new ImageResizeRunner((ImageResizeStep) pipelineStep);
    }
}
